...
if __name__=="__main__":
    ...
    for selectedDataset in Datasets_To_test:
        ...
        if selectedDataset=="caltech101" :
            ...
            dataset = ImageNetDataset(filter_label=None,images_path="/datasets/ImageNet/data/winter21_whole",preprocessin_fn=dinov1_model.dinov1_transform,subset="train",test_split=TEST_SPLIT_FOR_ZERO_SHOT_RETRIEVAL, random_seed=SEED_FOR_RANDOM_SPLIT)
            test_dataset = ImageNetDataset(filter_label=None,images_path="/datasets/ImageNet/data/winter21_whole",preprocessin_fn=dinov1_model.dinov1_transform,subset="test",test_split=TEST_SPLIT_FOR_ZERO_SHOT_RETRIEVAL, random_seed=SEED_FOR_RANDOM_SPLIT)
